package me.ztiany.androidav.video.codec.livecamera.client;
...
import me.ztiany.androidav.video.codec.SocketLive;
import me.ztiany.androidav.video.codec.livecamera.Constants;
import me.ztiany.androidav.video.codec.livecamera.DecodePlayerLiveH265;
import me.ztiany.androidav.video.codec.livecamera.EncodePushLiveH265;
import me.ztiany.androidav.video.codec.livecamera.LocalSurfaceView;

public class LiveCameraClientActivity extends AppCompatActivity {
    ...
    public void connect(View view) {
        ...
        if (mEncodePushLiveH265 == null) {
            mSocketLive = new SocketLiveClient(data -> mDecodePlayerLiveH265.push(data), Constants.SERVER_ADDRESS);
            mSocketLive.start();
