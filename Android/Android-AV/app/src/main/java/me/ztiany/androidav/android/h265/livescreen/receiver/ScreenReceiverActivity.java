...
import me.ztiany.androidav.utils.ViewsKt;
...
public class ScreenReceiverActivity extends AppCompatActivity implements SocketLiveClient.SocketCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(surfaceView, ViewsKt.newMMLayoutParams());
    ...
    private void initSocket() {
        mScreenLive = new SocketLiveClient(this, 12001);
        mScreenLive.start();
    }

    @Override
    public void callBack(byte[] data) {
        Timber.i("接收到消息: %d", data.length);
