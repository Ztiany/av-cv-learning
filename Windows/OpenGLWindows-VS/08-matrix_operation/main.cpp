...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	...
	*/
	...
	while (true) {//这个 while 的执行跟刷新率有关系，比如 60hz 的刷新率每秒跑 60 次。
		...
		//缩放：缩放的是坐标。
		glScalef(3.9F, 1.9F, 1.0F);
		/*
		旋转：第一个参数为角度，后面三个参数为 x,y,z 轴。
		旋转方向的判断：
			1. 比如旋转轴是 [0,0,1]。表示按 z 轴的方向旋转，即 z 轴是旋转轴；另外 z 轴的向量 > 1，表示从屏幕垂直出来的方向【右手坐标系】。
			2. 右手握拳，用大拇指指着旋转轴【z 轴】出来的方向【即指着自己的鼻子】，其他四个手指握拳的方向就是旋转的方向。
		*/
