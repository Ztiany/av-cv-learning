package me.ztiany.androidav.utils;
...
public class AppDirectory {
    ...
    public static File getImageCacheDir() {
        File cacheDirectory = AppContext.get().getExternalCacheDir();
    ...
    private static String getAppExternalPrivatePath(String type) {
        ...
        if (!Environment.MEDIA_MOUNTED.equals(state)) {
            savePath = AppContext.get().getFilesDir() + File.separator;
        } else {
            savePath = AppContext.get().getExternalFilesDir(type) + File.separator;
        }
        return savePath;
    }
    ...
    private static String getAppExternalPrivateCachePath() {
        ...
        String savePath;
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            savePath = AppContext.get().getExternalCacheDir() + File.separator;
        } else {
            savePath = AppContext.get().getCacheDir() + File.separator;
        }
        return savePath;
    }
    ...
    public static File getSDCardPublicDirectoryPath(@NonNull String type) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            dir = new File(AppContext.get().getFilesDir(), type);
        }
