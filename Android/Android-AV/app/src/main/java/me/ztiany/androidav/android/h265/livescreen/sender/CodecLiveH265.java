...
import static me.ztiany.androidav.android.h265.livescreen.Constants.HEIGHT;
import static me.ztiany.androidav.android.h265.livescreen.Constants.WIDTH;

import me.ztiany.androidav.android.h265.livescreen.Constants;
...
public class CodecLiveH265 extends Thread {
    ...
    private void dealFrame(ByteBuffer bb, MediaCodec.BufferInfo bufferInfo) {
        ...
        if (type == NAL_VPS) {//如果是 VPS，则缓存下来
            ...
            Timber.d("视频数据：%s", Arrays.toString(bytes));
        }
